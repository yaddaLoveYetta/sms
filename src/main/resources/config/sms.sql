...
GO
DBCC CHECKIDENT(N'[t_sms_log]', RESEED, 13169)
GO
IF ((SELECT COUNT(*) from fn_listextendedproperty('MS_Description', 
'SCHEMA', N'dbo', 
'TABLE', N't_sms_log', 
...
-- ----------------------------
if object_id(N't_user_session',N'U') is not null
...
IF ((SELECT COUNT(*) from fn_listextendedproperty('MS_Description', 
'SCHEMA', N'dbo', 
'TABLE', N't_user_session', 
'COLUMN', N'userId')) > 0) 
EXEC sp_updateextendedproperty @name = N'MS_Description', @value = N'用户内码'
, @level0type = 'SCHEMA', @level0name = N'dbo'
, @level1type = 'TABLE', @level1name = N't_user_session'
, @level2type = 'COLUMN', @level2name = N'userId'
ELSE
EXEC sp_addextendedproperty @name = N'MS_Description', @value = N'用户内码'
, @level0type = 'SCHEMA', @level0name = N'dbo'
, @level1type = 'TABLE', @level1name = N't_user_session'
, @level2type = 'COLUMN', @level2name = N'userId'
GO
...
'TABLE', N't_user_session', 
'COLUMN', N'session')) > 0) 
EXEC sp_updateextendedproperty @name = N'MS_Description', @value = N'session'
, @level0type = 'SCHEMA', @level0name = N'dbo'
, @level1type = 'TABLE', @level1name = N't_user_session'
, @level2type = 'COLUMN', @level2name = N'session'
ELSE
EXEC sp_addextendedproperty @name = N'MS_Description', @value = N'session'
, @level0type = 'SCHEMA', @level0name = N'dbo'
, @level1type = 'TABLE', @level1name = N't_user_session'
, @level2type = 'COLUMN', @level2name = N'session'
GO
