...
public class RoleService extends BaseService implements IRoleService {
     ...
     *
     * @param list
     * @param key   list中map元素的key
     * @param value list中map元素的value
     * @return
     */
     ...
     *
     * @param accessMap  角色对所有模块的权限掩码
     * @param topClassID 一级系统ID
     * @param subSysID   二级系统ID
     * @param accessMask 明细权限掩码
     * @return
     */
        ...
        for (int i = 0; i < arry.size(); i++) {
            ...
            if (objectTypes.containsKey(key)) {
                ...
                for (AccessControl accessControl : list) {
                    ...
                    if (accessControl.getObjectType().equals(objectType) && accessControl.getObjectId().equals(objectId)) {
                        // 已存在
                        isExist = true;
                        break;
                    }
