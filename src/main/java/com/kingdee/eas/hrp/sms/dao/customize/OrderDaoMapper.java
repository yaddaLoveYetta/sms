...
public interface OrderDaoMapper {
	...
	//收货单追踪查询
	List<Map<String, Object>> selectPurReceival(@Param("orderId")String orderId,@Param("number")String number,@Param("name")String name,@Param("startTime")Date startTime,@Param("endTime")Date endTime);
}
