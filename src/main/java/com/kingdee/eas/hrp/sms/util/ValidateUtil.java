...
public class ValidateUtil {
    ...
    private static Pattern NUMBER_PATTERN = Pattern.compile("^[0-9]+(.[0-9]{0,2})?$");
    private static Pattern MATCH_PATTERN = Pattern.compile("[()]");
    private static Pattern REPLACE_PATTERN = Pattern.compile("[(][^()]*[)]");
    private static Pattern MATCH_2_PATTERN = Pattern.compile("<[^<>]*(((?'Open'>)[^<>]*)+((?\'-Open\'>)[^<>]*)+)*(?(Open)(?!))>");
    private static Pattern MOBILE_PATTERN = Pattern.compile("^(13|14|15|17|18|19)\\d{9}$");
    ...
    public static boolean isMatchParenTheses(String str) {
        ...
        Matcher isParenTheses = MATCH_PATTERN.matcher(s);
        return !isParenTheses.find();
    }

    private static String replaceParenTheses(String str) {

        Matcher isParenTheses = REPLACE_PATTERN.matcher(str);
    ...
    private static boolean isMatchParenTheses2(String str) {
        Matcher isParenTheses = MATCH_2_PATTERN.matcher(str);
    ...
    public static String replaceEmoji(String str) {
        ...
        Matcher isEmoji = EMOJI_PATTERN.matcher(str);
        if (isEmoji.find()) {
            str = str.replaceAll("[\ud83c\udc00-\ud83c\udfff]|[\ud83d\udc00-\ud83d\udfff]|[\u2600-\u27ff]", "");
        }
        return str;
