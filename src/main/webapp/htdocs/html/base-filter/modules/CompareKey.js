define('CompareKey', function(require, module, exports) {
	...
	var dataTypeJson = {
		//数字
		1: [{name:"等于",value:"="},{name:"小于",value:"<"},{name:"小于等于",value:"<="},{name:"大于",value:">"},{name:"大于等于",value:">="}],
		//文本值
		2: [{name:"包含",value:"like"},{name:"等于",value:"="}],
		//日期时间
		3: [{name:"等于",value:"="},{name:"小于",value:"<"},{name:"小于等于",value:"<="},{name:"大于",value:">"},{name:"大于等于",value:">="}],
		//布尔
		4: [{name:"等于",value:"="}]
	};
