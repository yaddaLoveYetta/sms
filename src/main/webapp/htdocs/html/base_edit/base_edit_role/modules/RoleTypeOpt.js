 ...
 * 用户操作定制模块
 */
define('RoleTypeOpt', function (require, module, exports) {
    var $ = require('$');
    ...
    function render(userTypeId) {
        ...
        //}
        mastInputClass(userTypeId == 50702, $("#bd-FCompany"));
        disableElement(!(userTypeId == 50702), "F7", $("#bd-FCompany"));//
    };
